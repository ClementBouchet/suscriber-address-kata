Feature: Modify the address of a subscriber
  ...
  Scenario Outline: Modification of the address of a subscriber living in France and without an effective date
   ...
   Examples: the advisor modifies the subscriber's address without effective date
   |canal|
   |FACE|
   |EC|
